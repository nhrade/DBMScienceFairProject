...
<h2
    <a class="student" type="button" onclick="location.href='CreateAccount.php'">Add A Student</a>
</h2>
<p>
...
<h2
<a class="student" type="button" onclick="location.href='CreateAccount.php'">Modify A Student</a>
</h2>
<p>
